...
printf("TcpServer.cpp timer_start =====================%d\n", __LINE__); fflush(stdout); //FIXME!!
...
printf("TcpServer.cpp do_something =====================%d\n", __LINE__); fflush(stdout); //FIXME!!
...
printf("TcpServer.cpp thread_function02 =====================%d\n", __LINE__); fflush(stdout); //FIXME!!
...
printf("TcpServer.cpp thread_function01 =====================%d\n", __LINE__); fflush(stdout); //FIXME!!
...
printf("TcpServer.cpp TcpServer =====================%d\n", __LINE__); fflush(stdout); //FIXME!!
  start_accept();
}
TcpServer::~TcpServer(){
    //io_service.stop();
...
printf("TcpServer.cpp tomaPuerto =====================%d\n", __LINE__); fflush(stdout); //FIXME!!
      this->puerto = puerto;
}
long int TcpServer::getterData(){
printf("TcpServer.cpp getterData =====================%d\n", __LINE__); fflush(stdout); //FIXME!!
      return puerto;
}
void TcpServer::start_accept(){
printf("TcpServer.cpp start_accept =====================%d\n", __LINE__); fflush(stdout); //FIXME!!
