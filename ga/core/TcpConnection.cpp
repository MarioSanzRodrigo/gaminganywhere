...
printf("TcpConnection.cpp getStreamer =====================%d\n", __LINE__); fflush(stdout); //FIXME!!
    return m_Streamer;
}

RTSP_CMD_TYPES TcpConnection::getC(){
printf("TcpConnection.cpp getC =====================%d\n", __LINE__); fflush(stdout); //FIXME!!
    return C;
}
...
printf("TcpConnection.cpp Handle_RtspOPTION =====================%d\n", __LINE__); fflush(stdout); //FIXME!!
...
printf("TcpConnection.cpp Handle_RtspPAUSE =====================%d\n", __LINE__); fflush(stdout); //FIXME!!
    printf("EN PAUSE\n");
    char   response[1024];
...
printf("TcpConnection.cpp Handle_RtspDESCRIBE =====================%d\n", __LINE__); fflush(stdout); //FIXME!!
...
printf("TcpConnection.cpp Handle_RtspSETUP =====================%d\n", __LINE__); fflush(stdout); //FIXME!!
    char response[1024];
    char Transport[255];
...
printf("TcpConnection.cpp Handle_RtspPLAY =====================%d\n", __LINE__); fflush(stdout); //FIXME!!
    char   response[1024];
...
printf("TcpConnection.cpp ParseRtspRequest =====================%d\n", __LINE__); fflush(stdout); //FIXME!!
